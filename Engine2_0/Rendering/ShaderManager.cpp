...
{
	unsigned char compileFlags = (VERTEX_SHADER | FRAGMENT_SHADER);
...
bool ShaderManager::LoadShader(std::string fileName, ShaderEnums::Name shaderName, unsigned char compileFlags)
{
...
GLuint ShaderManager::CreateShader(std::string shader, GLenum type_shader)
{
